...
- [![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)][tweet] about Angular Deal's clone
...
- Fix bugs and UI enhancements for Angular Deal's clone.
...
I learned a lot of stuff. I know you might also have a curiosity about the process of building the same scale app as well. That's why I am writing a tutorial series on how I built Angular Deal's clone from scratch. I hope you guys will learn something from that too :)
...
It is a side project that I only spent time outside of the office hours to work on. One day, my team and I were fire fighting on PROD until 11 PM. After taking a shower, I continue with Angular Deal's clone for another two hours...
